...
class Incident extends Ticket
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey("service_id", array("targetclass"=>'Service', "allowed_values"=>new ValueSetObjects("SELECT Service AS s JOIN lnkCustomerContractToService AS l1 ON l1.service_id=s.id JOIN CustomerContract AS cc ON l1.customercontract_id=cc.id WHERE s.servicefamily_id = :this->servicefamily_id AND cc.org_id = :this->org_id AND s.status != 'obsolete'"), "sql"=>'service_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "depends_on"=>array('org_id', 'servicefamily_id'), "allow_target_creation"=>false, "display_style"=>'select', "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("resolution_code", array("allowed_values"=>new ValueSetEnum("software patch,training,hardware repair,system update,bug fixed,data modified,test drills,documented,assistance,work-around,change odu,change idu,change idu and odu,change satellite to echostart 19,change satellite to hughes 63w,nmc solution,unknown,troubleshooting"), "display_style"=>'list', "sql"=>'resolution_code', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("user_satisfaction", array("allowed_values"=>new ValueSetEnum("1,2,3,4,5"), "display_style"=>'list', "sql"=>'user_satisfaction', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("clarity_information", array("allowed_values"=>new ValueSetEnum("1,2,3,4,5"), "display_style"=>'list', "sql"=>'clarity_information', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("time_required", array("allowed_values"=>new ValueSetEnum("1,2,3,4,5"), "display_style"=>'list', "sql"=>'time_required', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey("servicefamily_id", array("targetclass"=>'ServiceFamily', "allowed_values"=>null, "sql"=>'servicefamily_id', "is_null_allowed"=>false, "on_target_delete"=>DEL_MANUAL, "depends_on"=>array(), "display_style"=>'select', "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEmailAddress("correo_instalador", array("allowed_values"=>null, "sql"=>'correo_instalador', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("apellido_instalador", array("allowed_values"=>null, "sql"=>'apellido_instalador', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'clarity_information' => OPT_ATT_HIDDEN,
					'time_required' => OPT_ATT_HIDDEN,
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'situacion_actual' => OPT_ATT_MUSTPROMPT,
  ...
  array (
    ...
    array (
      ...
      14 => 'sqf',
      15 => 'version',
      16 => 'equipment_state_cod',
      17 => 'attempts',
      18 => 'idu',
      19 => 'odu',
      20 => 'idu_odu_status',
      21 => 'idu_software_version',
      22 => 'external_id',
    ),
  ...
  12 => 'sqf',
  13 => 'version',
  14 => 'equipment_state_cod',
  15 => 'attempts',
  16 => 'idu',
  17 => 'odu',
  18 => 'idu_odu_status',
  19 => 'idu_software_version',
  20 => 'start_date',
  21 => 'resolution_date',
  22 => 'close_date',
  23 => 'status',
  24 => 'operational_status',
  25 => 'caller_id',
  26 => 'origin',
  27 => 'impact',
  28 => 'urgency',
  29 => 'priority',
  30 => 'service_id',
  31 => 'servicesubcategory_id',
  32 => 'team_id',
  33 => 'agent_id',
  34 => 'escalation_flag',
  35 => 'resolution_code',
  36 => 'user_satisfaction',
  37 => 'sla_tto_passed',
  38 => 'sla_ttr_passed',
  39 => 'external_id',
));
