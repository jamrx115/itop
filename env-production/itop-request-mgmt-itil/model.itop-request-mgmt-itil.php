...
class UserRequest extends Ticket
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey("servicefamily_id", array("targetclass"=>'ServiceFamily', "allowed_values"=>new ValueSetObjects("SELECT ServiceFamily"), "sql"=>'servicefamily_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "depends_on"=>array(), "allow_target_creation"=>false, "display_style"=>'select', "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey("service_id", array("targetclass"=>'Service', "allowed_values"=>new ValueSetObjects("SELECT Service AS s JOIN lnkCustomerContractToService AS l1 ON l1.service_id=s.id JOIN CustomerContract AS cc ON l1.customercontract_id=cc.id WHERE cc.org_id = :this->org_id AND  s.status != 'obsolete' AND servicefamily_id= :this->servicefamily_id"), "sql"=>'service_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "depends_on"=>array('org_id', 'servicefamily_id'), "allow_target_creation"=>false, "display_style"=>'select', "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("resolution_code", array("allowed_values"=>new ValueSetEnum("software patch,training,hardware repair,system update,bug fixed,data modified,test drills,documented,assistance,work-around,change odu,change idu,change idu and odu,change satellite to echostart 19,change satellite to hughes 63w,nmc solution,troubleshooting,unknown"), "display_style"=>'list', "sql"=>'resolution_code', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'servicefamily_id' => OPT_ATT_MANDATORY,
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'servicefamily_id' => OPT_ATT_MANDATORY | OPT_ATT_MUSTPROMPT,
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'servicefamily_id' => OPT_ATT_READONLY,
  ...
  31 => 'servicefamily_id',
  32 => 'service_id',
  33 => 'servicesubcategory_id',
  34 => 'team_id',
  35 => 'agent_id',
  36 => 'escalation_flag',
  37 => 'resolution_code',
  38 => 'user_satisfaction',
  39 => 'sla_tto_passed',
  40 => 'sla_ttr_passed',
  41 => 'external_id',
));
