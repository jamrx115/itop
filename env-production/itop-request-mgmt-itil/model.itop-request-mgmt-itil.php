...
class UserRequest extends Ticket
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("resolution_code", array("allowed_values"=>new ValueSetEnum("software patch,training,hardware repair,system update,bug fixed,data modified,test drills,documented,assistance,work-around,change odu,change idu,change idu and odu,change satellite to echostart 19,change satellite to hughes 63w,nmc solution,unknown"), "display_style"=>'list', "sql"=>'resolution_code', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
