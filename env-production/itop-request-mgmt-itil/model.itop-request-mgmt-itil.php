...
class UserRequest extends Ticket
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("resolution_code", array("allowed_values"=>new ValueSetEnum("software patch,training,hardware repair,system update,bug fixed,data modified,test drills,documented,assistance,work-around,unknown"), "display_style"=>'list', "sql"=>'resolution_code', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
  ...
  20 => 'servicefamily_id',
  21 => 'service_id',
  22 => 'servicesubcategory_id',
  23 => 'team_id',
  24 => 'agent_id',
  25 => 'escalation_flag',
  26 => 'resolution_code',
  27 => 'user_satisfaction',
  28 => 'sla_tto_passed',
  29 => 'sla_ttr_passed',
  30 => 'external_id',
));
