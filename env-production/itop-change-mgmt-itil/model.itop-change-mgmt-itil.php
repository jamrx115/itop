						<?php
//
// File generated by ... on the 2018-04-28T10:53:35-0500
...
class EmergencyChange extends ApprovedChange
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey("servicesubcategory_id", array("targetclass"=>'ServiceSubcategory', "allowed_values"=>new ValueSetObjects("SELECT ServiceSubcategory WHERE service_id = :this->service_id  AND status != 'obsolete'"), "sql"=>'servicesubcategory_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "depends_on"=>array('service_id'), "allow_target_creation"=>false, "display_style"=>'select', "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("pais_operacion", array("allowed_values"=>new ValueSetEnum("RQ-HDC,RQ-HPE,RQ-HCL,RQ-HEC,RQ-VAR PANAMÁ"), "display_style"=>'list', "sql"=>'pais_operacion', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
