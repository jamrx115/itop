...
class KnownError extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeHTML("step_by_step", array("allowed_values"=>null, "sql"=>'step_by_step', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "width"=>'900px', "height"=>'800px', "always_load_in_tables"=>true)));
