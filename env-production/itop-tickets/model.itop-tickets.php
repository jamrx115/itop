						<?php
//
// File generated by ... on the 2019-05-06T06:29:27+0200
  ...
  array (
    ...
    array (
      ...
      'rejected' => 'closed',
		...
		MetaModel::Init_AddAttribute(new AttributeString("id_instalador", array("allowed_values"=>null, "sql"=>'id_instalador', "default_value"=>'NA', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("san", array("allowed_values"=>null, "sql"=>'san', "default_value"=>'NA', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("nombre_instalador", array("allowed_values"=>null, "sql"=>'nombre_instalador', "default_value"=>'NA', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeString("odu", array("allowed_values"=>null, "sql"=>'odu', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("situacion_actual", array("allowed_values"=>null, "sql"=>'situacion_actual', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeString("beam", array("allowed_values"=>null, "sql"=>'beam', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeString("idu", array("allowed_values"=>null, "sql"=>'idu', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
