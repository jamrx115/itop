						<?php
//
// File generated by ... on the 2019-06-28T06:00:07+0200
  ...
  array (
    ...
    array (
      ...
      'rejected' => 'closed',
		...
		MetaModel::Init_AddAttribute(new AttributeString("id_instalador", array("allowed_values"=>null, "sql"=>'id_instalador', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeString("nombre_instalador", array("allowed_values"=>null, "sql"=>'nombre_instalador', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("pais_ticket", array("allowed_values"=>new ValueSetEnum("RQ-HDC,RQ-HPE,RQ-HCL,RQ-HEC,RQ-ARG,RQ-VAR PANAMÁ,RQ-LATAM"), "display_style"=>'list', "sql"=>'pais_ticket', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("sales_model", array("allowed_values"=>new ValueSetEnum("Retail,VAR"), "display_style"=>'list', "sql"=>'sales_model', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeString("fso", array("allowed_values"=>null, "sql"=>'fso', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
