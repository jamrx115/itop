						<?php
//
// File generated by ... on the 2019-03-28T18:33:47-0500
...
class UserRequest extends Ticket
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("user_satisfaction", array("allowed_values"=>new ValueSetEnum("1,2,3,4,5"), "display_style"=>'list', "sql"=>'user_satisfaction', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("clarity_information", array("allowed_values"=>new ValueSetEnum("1,2,3,4,5"), "display_style"=>'list', "sql"=>'clarity_information', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("time_required", array("allowed_values"=>new ValueSetEnum("1,2,3,4,5"), "display_style"=>'list', "sql"=>'time_required', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
