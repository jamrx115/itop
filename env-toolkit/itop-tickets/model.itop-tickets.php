  ...
  array (
    ...
    array (
      ...
      'rejected' => 'closed',
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("pais_ticket", array("allowed_values"=>new ValueSetEnum("RQ-HDC,RQ-HPE,RQ-HCL,RQ-HEC,RQ-VAR PANAMÁ,RQ-LATAM"), "display_style"=>'list', "sql"=>'pais_ticket', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
