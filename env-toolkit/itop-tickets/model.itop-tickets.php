						<?php
//
// File generated by ... on the 2020-07-24T00:08:47-0500
  ...
  array (
    ...
    array (
      ...
      'rejected' => 'closed',
		...
		MetaModel::Init_AddAttribute(new AttributeString("id_instalador", array("allowed_values"=>null, "sql"=>'id_instalador', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("san", array("allowed_values"=>null, "sql"=>'san', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("nombre_instalador", array("allowed_values"=>null, "sql"=>'nombre_instalador', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("pais_ticket", array("allowed_values"=>new ValueSetEnum("RQ-HDC,RQ-HPE,RQ-HCL,RQ-HEC,RQ-ARG,RQ-VAR PANAMA,RQ-LATAM"), "display_style"=>'list', "sql"=>'pais_ticket', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("sales_model", array("allowed_values"=>new ValueSetEnum("Retail,VAR,Express Wifi"), "display_style"=>'list', "sql"=>'sales_model', "default_value"=>'Retail', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("location", array("allowed_values"=>null, "sql"=>'location', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("odu", array("allowed_values"=>null, "sql"=>'odu', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("situacion_actual", array("allowed_values"=>new ValueSetEnum("FSO not released,Error-id customer,Reissue payment coupon,Payment coupon not generated or not sent,Wrong application of Payment,Payment applied but not reflected,Payment not refleted in payment coupon,Failure PSE site,Payment Portal Down,Payment Credit Card Fail,Upload photos for close FSO,Close FSO Fail,Re Schedule FSO,Can not launch OVT,Can not get a sign off code,Upload photos and customer sign,Upload Workflow Fail,Departure complete Fail,Line of sight issue,Install Parameters Data fail,Low SQF,Low SQF after the terminal activation,Terminal registration-activation fail,Wrong Beam,Service activation fail,Wrong satellite,Wrong Oasis version,Wrong install parameters outroute-polarity,SBC file issue,FSO blocked after multiple terminal activations,Service failed after new IDU is activated,Training Install,Validate FSO,IDU is failing,ODU is failing,IDU AND ODU are failing,No change Equipment,Service failed after new IDU is activated,Install Parameters Data fail,Training Repair,Training De-Install,Offer creation,User creation,Agent ID creation,Offer coverage,No aplica,Real Customer,Change address,Change condition,Error sent contract,Customer lastname with special character,Document CE with Expedition date wrong,Data management,Data maintenance,Change email,POW Fail,Whitelist,FSO not generated,Partner setup,Credit Scoring verification fail,Limit sales by ID,Black list,Bypass Credit Score,Disability Law,Disability Law and Bypass Credit Score,Family and Friends Order,Family and Friends Order and Bypass Crediy Score,Field Service Not Authorized,Cancel SAN,Refund,Distributors inquirys,Without Coverage,New SAN Correction,New SAN Relocation,Registration-Activation Successfully,AP Status Validation,AP Status Failed,HughesNet Degradation Service Validation,PQR Escalated,Coordinates fail in departure complete,Elderly People"), "display_style"=>'list', "sql"=>'situacion_actual', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("sqf", array("allowed_values"=>null, "sql"=>'sqf', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeString("attempts", array("allowed_values"=>null, "sql"=>'attempts', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("beam", array("allowed_values"=>null, "sql"=>'beam', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("equipment_state_cod", array("allowed_values"=>null, "sql"=>'equipment_state_cod', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("fso", array("allowed_values"=>null, "sql"=>'fso', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("idu", array("allowed_values"=>null, "sql"=>'idu', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("idu_odu_status", array("allowed_values"=>null, "sql"=>'idu_odu_status', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("idu_software_version", array("allowed_values"=>null, "sql"=>'idu_software_version', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
