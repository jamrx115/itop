...
Cuando se asocien con un disparador, cada acción recibe un número de "orden", esto especifica en que orden se ejecutaran las acciones.</p>',
	...
	'Class:Incident/Attribute:resolution_code/Value:work-around+' => 'Ruta alterna',
	'Class:Incident/Attribute:resolution_code/Value:change odu' => 'ODU cambiado',
	'Class:Incident/Attribute:resolution_code/Value:change odu+' => '',
	'Class:Incident/Attribute:resolution_code/Value:change idu' => 'IDU cambiado',
	'Class:Incident/Attribute:resolution_code/Value:change idu+' => '',
	'Class:Incident/Attribute:resolution_code/Value:change idu and odu' => 'IDU y ODU cambiado',
	'Class:Incident/Attribute:resolution_code/Value:change idu and odu+' => '',
	'Class:Incident/Attribute:resolution_code/Value:change satellite to echostart 19' => 'Cambio de satelite a Echostart19',
	'Class:Incident/Attribute:resolution_code/Value:change satellite to echostart 19+' => '',
	'Class:Incident/Attribute:resolution_code/Value:change satellite to hughes 63w' => 'Cambio de satelite a hughes 63W',
	'Class:Incident/Attribute:resolution_code/Value:change satellite to hughes 63w+' => '',
	'Class:Incident/Attribute:resolution_code/Value:nmc solution' => 'Solucionado por NMC',
	'Class:Incident/Attribute:resolution_code/Value:nmc solution+' => '',
	...
	'Class:Incident/Attribute:public_log+' => 'Bitácora Pública',
	'Class:Incident/Attribute:user_satisfaction' => 'Trato recibido durante la atención',
	'Class:Incident/Attribute:user_satisfaction+' => 'Trato recibido durante la atención',
	'Class:Incident/Attribute:user_satisfaction/Value:1' => 'Malo',
	'Class:Incident/Attribute:user_satisfaction/Value:1+' => 'Malo',
	'Class:Incident/Attribute:user_satisfaction/Value:2' => 'Regular',
	'Class:Incident/Attribute:user_satisfaction/Value:2+' => 'Regular',
	'Class:Incident/Attribute:user_satisfaction/Value:3' => 'Aceptable',
	'Class:Incident/Attribute:user_satisfaction/Value:3+' => 'Aceptable',
	'Class:Incident/Attribute:user_satisfaction/Value:4' => 'Bueno',
	'Class:Incident/Attribute:user_satisfaction/Value:4+' => 'Bueno',
	'Class:Incident/Attribute:user_satisfaction/Value:5' => 'Excelente',
	'Class:Incident/Attribute:user_satisfaction/Value:5+' => 'Excelente',
	'Class:Incident/Attribute:clarity_information' => 'Claridad de la informacion proporcionada para solucionar el caso',
	'Class:Incident/Attribute:clarity_information+' => 'Claridad de la informacion proporcionada para solucionar el caso',
	'Class:Incident/Attribute:clarity_information/Value:1' => 'Malo',
	'Class:Incident/Attribute:clarity_information/Value:1+' => 'Malo',
	'Class:Incident/Attribute:clarity_information/Value:2' => 'Regular',
	'Class:Incident/Attribute:clarity_information/Value:2+' => 'Regular',
	'Class:Incident/Attribute:clarity_information/Value:3' => 'Aceptable',
	'Class:Incident/Attribute:clarity_information/Value:3+' => 'Aceptable',
	'Class:Incident/Attribute:clarity_information/Value:4' => 'Bueno',
	'Class:Incident/Attribute:clarity_information/Value:4+' => 'Bueno',
	'Class:Incident/Attribute:clarity_information/Value:5' => 'Excelente',
	'Class:Incident/Attribute:clarity_information/Value:5+' => 'Excelente',
	'Class:Incident/Attribute:time_required' => 'Tiempo requerido para la solucion del caso',
	'Class:Incident/Attribute:time_required+' => 'Tiempo requerido para la solucion del caso',
	'Class:Incident/Attribute:time_required/Value:1' => 'Malo',
	'Class:Incident/Attribute:time_required/Value:1+' => 'Malo',
	'Class:Incident/Attribute:time_required/Value:2' => 'Regular',
	'Class:Incident/Attribute:time_required/Value:2+' => 'Regular',
	'Class:Incident/Attribute:time_required/Value:3' => 'Aceptable',
	'Class:Incident/Attribute:time_required/Value:3+' => 'Aceptable',
	'Class:Incident/Attribute:time_required/Value:4' => 'Bueno',
	'Class:Incident/Attribute:time_required/Value:4+' => 'Bueno',
	'Class:Incident/Attribute:time_required/Value:5' => 'Excelente',
	'Class:Incident/Attribute:time_required/Value:5+' => 'Excelente',
	...
	'Class:Problem/Attribute:knownerrors_list+' => 'Errores Conocidos',
	'Class:Problem/Attribute:related_request_list' => 'Ticker Incidentes Relacionados',
	'Class:Problem/Attribute:related_request_list+' => 'Ticker Incidentes Relacionados',
	...
	'Menu:RequestManagementProvider+' => 'Proveedor de Mesa de Ayuda',
	'Menu:UserRequest:Provider' => 'Solicitudes Abiertos transferidos a Proveedor',
	'Menu:UserRequest:Provider+' => 'Solicitudes Abiertos transferidos a Proveedor',
	'Menu:UserRequest:Overview' => 'Resumen de Solicitudes',
	'Menu:UserRequest:Overview+' => 'Resumen de Solicitudes',
	'Menu:NewUserRequest' => 'Nueva Solicitud',
	'Menu:NewUserRequest+' => 'Nueva Solicitud',
	'Menu:SearchUserRequests' => 'Búsqueda de Solicitudes',
	'Menu:SearchUserRequests+' => 'Búsqueda de Solicitudes',
	'Menu:UserRequest:Shortcuts' => 'Acceso Rápido',
	'Menu:UserRequest:Shortcuts+' => 'Acceso Rápido',
	'Menu:UserRequest:MyRequests' => 'Solicitudes Asignados a Mí',
	'Menu:UserRequest:MyRequests+' => 'Solicitudes Asignados a Mí (como Analista)',
	...
	'Menu:UserRequest:EscalatedRequests+' => 'Solicitudes Escaladas',
	'Menu:UserRequest:OpenRequests' => 'Solicitudes Abiertos',
	'Menu:UserRequest:OpenRequests+' => 'Solicitudes Abiertos',
	'Menu:UserRequest:OpenProblems' => 'Problemas Abiertos',
	'Menu:UserRequest:OpenProblems+' => 'Problemas Abiertos',
	'UI:WelcomeMenu:MyAssignedCalls' => 'Solicitudes Asignados a Mí',
	'UI-RequestManagementOverview-RequestByType-last-14-days' => 'Solicitudes por Tipo de los Últimos 14 días',
	'UI-RequestManagementOverview-Last-14-days' => 'Número de Solicitudes de los Últimos 14 días',
	'UI-RequestManagementOverview-OpenRequestByStatus' => 'Solicitudes Abiertos por Estatus',
	'UI-RequestManagementOverview-OpenRequestByAgent' => 'Solicitudes Abiertos por Analista',
	'UI-RequestManagementOverview-OpenRequestByType' => 'Solicitudes Abiertos por Tipo',
	'UI-RequestManagementOverview-OpenRequestByCustomer' => 'Solicitudes Abiertos por Cliente',
	...
	'Class:UserRequest/Attribute:approver_email+' => 'Correo Electrónico del Aprobador',
	'Class:UserRequest/Attribute:servicefamily_id' => 'Plataforma',
	'Class:UserRequest/Attribute:servicefamily_id+' => 'Plataforma',
	'Class:UserRequest/Attribute:servicefamily_name' => 'Plataforma',
	'Class:UserRequest/Attribute:servicefamily_name+' => 'Plataforma',
	...
	'Class:UserRequest/Attribute:situacion_actual' => 'Situacion actual',
	'Class:UserRequest/Attribute:situacion_actual+' => 'Situacion actual',
	...
	'Class:UserRequest/Attribute:resolution_code/Value:bug fixed+' => 'Falla Corregida',
	'Class:UserRequest/Attribute:resolution_code/Value:data modified' => 'Datos Modificados',
	'Class:UserRequest/Attribute:resolution_code/Value:data modified+' => 'Datos Modificados',
	'Class:UserRequest/Attribute:resolution_code/Value:test drills' => 'Ejecucion de Pruebas',
	'Class:UserRequest/Attribute:resolution_code/Value:test drills+' => 'Ejecucion de Pruebas',
	'Class:UserRequest/Attribute:resolution_code/Value:documented' => 'Documentación',
	'Class:UserRequest/Attribute:resolution_code/Value:documented+' => 'Documentación',
	'Class:UserRequest/Attribute:resolution_code/Value:hardware repair' => 'Reparación de Hardware',
	'Class:UserRequest/Attribute:resolution_code/Value:hardware repair+' => 'Reparación de Hardware',
	'Class:UserRequest/Attribute:resolution_code/Value:unknown' => 'Desconocido',
	'Class:UserRequest/Attribute:resolution_code/Value:unknown+' => 'Desconocido',
	'Class:UserRequest/Attribute:resolution_code/Value:work-around' => 'Ruta alterna',
	'Class:UserRequest/Attribute:resolution_code/Value:work-around+' => 'Ruta alterna',
	'Class:UserRequest/Attribute:resolution_code/Value:change odu' => 'ODU cambiado',
	'Class:UserRequest/Attribute:resolution_code/Value:change odu+' => '',
	'Class:UserRequest/Attribute:resolution_code/Value:change idu' => 'IDU cambiado',
	'Class:UserRequest/Attribute:resolution_code/Value:change idu+' => '',
	'Class:UserRequest/Attribute:resolution_code/Value:change idu and odu' => 'IDU y ODU cambiado',
	'Class:UserRequest/Attribute:resolution_code/Value:change idu and odu+' => '',
	'Class:UserRequest/Attribute:resolution_code/Value:change satellite to echostart 19' => 'Cambio de satelite a Echostart19',
	'Class:UserRequest/Attribute:resolution_code/Value:change satellite to echostart 19+' => '',
	'Class:UserRequest/Attribute:resolution_code/Value:change satellite to hughes 63w' => 'Cambio de satelite a hughes 63W',
	'Class:UserRequest/Attribute:resolution_code/Value:change satellite to hughes 63w+' => '',
	'Class:UserRequest/Attribute:resolution_code/Value:nmc solution' => 'Solucionado por NMC',
	'Class:UserRequest/Attribute:resolution_code/Value:nmc solution+' => '',
	...
	'Class:UserRequest/Attribute:parent_change_ref+' => 'Ref. Cambio',
	'Class:UserRequest/Attribute:related_request_list' => 'Solicitudess Hijo',
	'Class:UserRequest/Attribute:related_request_list+' => 'Solicitudess Hijo',
	'Class:UserRequest/Attribute:public_log' => 'Bitácora Pública',
	'Class:UserRequest/Attribute:public_log+' => 'Bitácora Pública',
	'Class:UserRequest/Attribute:user_satisfaction' => 'Trato recibido durante la atención',
	'Class:UserRequest/Attribute:user_satisfaction+' => 'Trato recibido durante la atención',
	'Class:UserRequest/Attribute:user_satisfaction/Value:1' => 'Malo',
	'Class:UserRequest/Attribute:user_satisfaction/Value:1+' => 'Malo',
	'Class:UserRequest/Attribute:user_satisfaction/Value:2' => 'Regular',
	'Class:UserRequest/Attribute:user_satisfaction/Value:2+' => 'Regular',
	'Class:UserRequest/Attribute:user_satisfaction/Value:3' => 'Aceptable',
	'Class:UserRequest/Attribute:user_satisfaction/Value:3+' => 'Aceptable',
	'Class:UserRequest/Attribute:user_satisfaction/Value:4' => 'Bueno',
	'Class:UserRequest/Attribute:user_satisfaction/Value:4+' => 'Bueno',
	'Class:UserRequest/Attribute:user_satisfaction/Value:5' => 'Excelente',
	'Class:UserRequest/Attribute:user_satisfaction/Value:5+' => 'Excelente',
	'Class:UserRequest/Attribute:clarity_information' => 'Claridad de la informacion proporcionada para solucionar el caso',
	'Class:UserRequest/Attribute:clarity_information+' => 'Claridad de la informacion proporcionada para solucionar el caso',
	'Class:UserRequest/Attribute:clarity_information/Value:1' => 'Malo',
	'Class:UserRequest/Attribute:clarity_information/Value:1+' => 'Malo',
	'Class:UserRequest/Attribute:clarity_information/Value:2' => 'Regular',
	'Class:UserRequest/Attribute:clarity_information/Value:2+' => 'Regular',
	'Class:UserRequest/Attribute:clarity_information/Value:3' => 'Aceptable',
	'Class:UserRequest/Attribute:clarity_information/Value:3+' => 'Aceptable',
	'Class:UserRequest/Attribute:clarity_information/Value:4' => 'Bueno',
	'Class:UserRequest/Attribute:clarity_information/Value:4+' => 'Bueno',
	'Class:UserRequest/Attribute:clarity_information/Value:5' => 'Excelente',
	'Class:UserRequest/Attribute:clarity_information/Value:5+' => 'Excelente',
	'Class:UserRequest/Attribute:time_required' => 'Tiempo requerido para la solucion del caso',
	'Class:UserRequest/Attribute:time_required+' => 'Tiempo requerido para la solucion del caso',
	'Class:UserRequest/Attribute:time_required/Value:1' => 'Malo',
	'Class:UserRequest/Attribute:time_required/Value:1+' => 'Malo',
	'Class:UserRequest/Attribute:time_required/Value:2' => 'Regular',
	'Class:UserRequest/Attribute:time_required/Value:2+' => 'Regular',
	'Class:UserRequest/Attribute:time_required/Value:3' => 'Aceptable',
	'Class:UserRequest/Attribute:time_required/Value:3+' => 'Aceptable',
	'Class:UserRequest/Attribute:time_required/Value:4' => 'Bueno',
	'Class:UserRequest/Attribute:time_required/Value:4+' => 'Bueno',
	'Class:UserRequest/Attribute:time_required/Value:5' => 'Excelente',
	'Class:UserRequest/Attribute:time_required/Value:5+' => 'Excelente',
	...
	'Menu:RequestTemplate' => 'Plantillas de Solicitudes',
	'Menu:RequestTemplate+' => 'Plantillas de Solicitudes',
	...
	'Class:ServiceSubcategory/Attribute:request_type/Value:incident+' => 'Incidente',
	'Class:ServiceSubcategory/Attribute:request_type/Value:service_request' => 'Solicitudes de Servicio',
	'Class:ServiceSubcategory/Attribute:request_type/Value:service_request+' => 'Solicitudes de Servicio',
	...
	'Class:SLT/Attribute:request_type/Value:incident+' => 'Incidente',
	'Class:SLT/Attribute:request_type/Value:servicerequest' => 'Solicitudes de Servicio',
	'Class:SLT/Attribute:request_type/Value:servicerequest+' => 'Solicitudes de Servicio',
	...
	'Class:Ticket/Attribute:odu+' => 'Esn ODU , Esn Segundo ODU (Si el primero fue cambiado) , etc.',
	'Class:Incident/Attribute:servicefamily_id' => 'Plataforma',
	'Class:Incident/Attribute:servicefamily_id+' => 'Plataforma',
	'Class:Ticket/Attribute:sqf' => 'SQF',
	'Class:Ticket/Attribute:sqf+' => 'SQF',
	'Class:Ticket/Attribute:version' => 'Versión',
	'Class:Ticket/Attribute:version+' => 'Versión del archivo SBC /Versión previa del OASIS/Versión OASIS',
	...
	'Class:Ticket/Attribute:attempts' => 'Intentos',
	'Class:Ticket/Attribute:attempts+' => 'Número de intentos lanzar OVT/Intentos para activar/Registros de IDU/Activación del servicio/Reinicios del modem',
	'Class:Ticket/Attribute:beam' => 'Beam',
	'Class:Ticket/Attribute:beam+' => 'Beam',
	'Class:Ticket/Attribute:equipment_state_cod' => 'Código de estado de equipos',
	'Class:Ticket/Attribute:equipment_state_cod+' => 'Código estado del terminal/Código estado del sistema',
	'Class:Ticket/Attribute:fso' => 'FSO',
	'Class:Ticket/Attribute:fso+' => 'FSO',
	'Class:Incident/Attribute:external_id' => 'ID Externo',
	'Class:Ticket/Attribute:idu' => 'IDU',
	'Class:Ticket/Attribute:idu+' => 'Esn IDU , Esn Segundo IDU (Si el primero fue cambiado) , etc.',
	'Class:Ticket/Attribute:idu_odu_status' => 'Estado IDU/ODU',
	'Class:Ticket/Attribute:idu_odu_status+' => 'Estado del Esn IDU, Estado del Esn ODU, etc.',
	'Class:Ticket/Attribute:idu_software_version' => 'Versión software IDU',
	'Class:Ticket/Attribute:idu_software_version+' => 'Versión de software IDU, versión de software segundo IDU, etc.',
));