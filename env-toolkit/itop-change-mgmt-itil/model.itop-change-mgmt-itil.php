						<?php
//
// File generated by ... on the 2018-04-06T13:09:33-0500
...
class EmergencyChange extends ApprovedChange
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("pais_operacion", array("allowed_values"=>new ValueSetEnum("RQ-HDC,RQ-HPE,RQ-HCL,RQ-VAR PANAMÁ"), "display_style"=>'list', "sql"=>'pais_operacion', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
