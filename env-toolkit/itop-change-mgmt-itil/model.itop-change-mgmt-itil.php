...
abstract class Change extends Ticket
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeString("external_id_cambios", array("allowed_values"=>null, "sql"=>'external_id_cambios', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalKey("servicefamily_key", array("targetclass"=>'ServiceFamily', "allowed_values"=>new ValueSetObjects("SELECT ServiceFamily"), "sql"=>'servicefamily_key', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "depends_on"=>array(), "allow_target_creation"=>false, "display_style"=>'select', "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalField("servicefamily_n", array("allowed_values"=>null, "extkey_attcode"=>'servicefamily_key', "target_attcode"=>'name', "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalKey("service_key", array("targetclass"=>'Service', "allowed_values"=>new ValueSetObjects("SELECT Service AS s JOIN lnkCustomerContractToService AS l1 ON l1.service_id=s.id JOIN CustomerContract AS cc ON l1.customercontract_id=cc.id WHERE cc.org_id = :this->org_id AND  s.status != 'obsolete' AND servicefamily_id= :this->servicefamily_key"), "sql"=>'service_key', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "depends_on"=>array('org_id', 'servicefamily_key'), "allow_target_creation"=>false, "display_style"=>'select', "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalField("service_n", array("allowed_values"=>null, "extkey_attcode"=>'service_key', "target_attcode"=>'name', "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalKey("servicesubcategory_key", array("targetclass"=>'ServiceSubcategory', "allowed_values"=>new ValueSetObjects("SELECT ServiceSubcategory WHERE service_id = :this->service_key  AND status != 'obsolete'"), "sql"=>'servicesubcategory_key', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "depends_on"=>array('service_key'), "allow_target_creation"=>false, "display_style"=>'select', "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeExternalField("servicesubcategory_n", array("allowed_values"=>null, "extkey_attcode"=>'servicesubcategory_key', "target_attcode"=>'name', "always_load_in_tables"=>false)));
  ...
  array (
    ...
    array (
      ...
      8 => 'pais_ticket',
      9 => 'fso',
      10 => 'servicefamily_key',
      11 => 'service_key',
      12 => 'servicesubcategory_key',
      13 => 'external_id_cambios',
      14 => 'description',
    ),
  ...
  10 => 'pais_ticket',
  11 => 'fso',
  12 => 'servicefamily_key',
  13 => 'service_key',
  14 => 'servicesubcategory_key',
  15 => 'external_id_cambios',
  16 => 'caller_id',
  17 => 'team_id',
  18 => 'agent_id',
  19 => 'supervisor_group_id',
  20 => 'supervisor_id',
  21 => 'manager_group_id',
  22 => 'manager_id',
  23 => 'reason',
  ...
  9 => 'servicefamily_key',
  10 => 'service_key',
  11 => 'servicesubcategory_key',
  12 => 'external_id_cambios',
  13 => 'start_date',
  14 => 'end_date',
  15 => 'status',
  16 => 'agent_id',
...
class RoutineChange extends Change
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeEnum("tipo_cambio", array("allowed_values"=>new ValueSetEnum("Patch to Fix,New Feature"), "display_style"=>'list', "sql"=>'tipo_cambio', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
  ...
  array (
    ...
    array (
      ...
      9 => 'pais_ticket',
      10 => 'fso',
      11 => 'servicefamily_key',
      12 => 'service_key',
      13 => 'servicesubcategory_key',
      14 => 'external_id_cambios',
      15 => 'tipo_cambio',
    ),
    'fieldset:Ticket:contact' => 
    array (
